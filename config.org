...
** Org
*** Capture templates
Add weekly review capture template.
#+begin_src emacs-lisp
(after! org
  (setq +org-capture-review-file (expand-file-name "reviews.org" org-directory))
  (mapc (lambda (template)
          (add-to-list 'org-capture-templates template))
        '(("r" "Review")
          ("rw" "Weekly" entry (file+olp+datetree +org-capture-review-file "Weekly") "* %U\n%?" :tree-type week)
          ("rm" "Monthly" entry (file+olp+datetree +org-capture-review-file "Monthly") "* %U\n%?")
          ("ry" "Yearly" entry (file+olp+datetree +org-capture-review-file "Yearly") "* %U\n%?"))))
#+end_src
*** Babel
**** http
...
#+RESULTS:
| W | Completed and/or deferred tasks from previous week | ((agenda  ((org-agenda-span 7) (org-agenda-start-day -7d) (org-agenda-show-log t))) (todo ) (todo DONE) (todo [X])) |
