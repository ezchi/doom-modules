...
(defun ec/at-home-p ()
  "Return non-nil if running Emacs on personal computer."
  (interactive)
  (string= (system-name) "Enzes-MacBook-Pro.local"))

(defun ec/at-office-p ()
  "Return non-nil if running Emacs not on personal computer."
  (interactive)
  (not (ec/at-home-p)))
#+end_src
