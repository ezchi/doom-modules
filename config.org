...
(after! centaur-tabs
  (map! :leader
        (:prefix-map ("TAB" . "Tab Group")
         :desc "Previous group" "p" #'centaur-tabs-backward-group
         :desc "Next group" "n" #'centaur-tabs-forward-group
         :desc "Switch group" "s" #'centaur-tabs-counsel-switch-group
         :desc "Group tabs by project" "P" #'centaur-tabs-group-by-projectile-project
         :desc "Group tabs by centaur" "G" #'centaur-tabs-group-buffer-groups)))
#+end_src
