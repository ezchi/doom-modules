...
*** Google calendar
#+begin_src emacs-lisp
(when (string= (getenv "MY_LOCATION") "@home")
  (use-package! org-gcal
    ...
    (setq org-gcal-client-id (ec/get-gcal-config-value 'client_id)
          ...
          org-gcal-fetch-file-alist '(("Enze.Chi@gmail.com" .  "~/org/gcal.org")))))
#+end_src
...
(when (string= (getenv "MY_LOCATION") "@office")
...
(if (string= (getenv "MY_LOCATION") "@home")
    (use-package! epa-file
      ...
      (epa-file-enable)
      (setq custom-file (concat doom-private-dir "private.el.gpg"))
